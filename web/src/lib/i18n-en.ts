...
export const EN_DICT: Record<string, string> = {
  ...
  "麦克风需要 HTTPS 或本机访问": "The microphone requires HTTPS or localhost",
  "浏览器拒绝了麦克风权限，目前只能听不能说": "Microphone permission was denied; this session is listen-only",
  "音频通道异常，信令仍可用": "Audio failed, but call signalling still works",
  来电: "Incoming",
  去电: "Outgoing",
  未知号码: "Unknown number",
  查看: "View",
  接听: "Answer",
  挂断: "Hang Up",
  "VoWiFi IMS 已就绪，接通后可在浏览器里通话": "VoWiFi IMS is ready. After the call connects, you can talk in the browser.",
  "当前走基站电路域，只能拨打、接听和挂断，浏览器没有声音": "This call uses the cellular circuit path. You can dial, answer, and hang up, but the browser has no audio.",
  "VoWiFi 音频": "VoWiFi audio",
  "电路域 · 无音频": "Circuit-switched · no audio",
  已静音: "Muted",
  麦克风: "Microphone",
  等待对端接通: "Waiting for the other party",
  输入号码: "Enter number",
  拨打: "Dial",
  设备离线时无法发起通话: "The device is offline, so a call cannot be placed",
  "USB SIM 读卡器只能在 VoWiFi IMS 就绪后通话": "USB SIM readers can place calls only after VoWiFi IMS is ready",
  最近通话: "Recent calls",
  还没有结束的通话: "No finished calls yet",
