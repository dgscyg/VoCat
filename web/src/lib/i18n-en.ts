...
export const EN_DICT: Record<string, string> = {
  ...
  "软电话": "Softphone",
  "在浏览器里拨打和接听当前线路，无需外部 SIP 客户端": "Place and receive calls on the current line in the browser; no external SIP client is needed",
  "选择线路": "Select line",
  ...
  "正在接通浏览器音频...": "Connecting browser audio...",
  "麦克风需要 HTTPS 或本机访问": "The microphone requires HTTPS or localhost access",
  "浏览器拒绝了麦克风权限，目前只能听不能说": "The browser denied microphone permission; you can listen but not speak",
  "音频通道异常，信令仍可用": "The audio channel failed; signalling still works",
  "等待对端接通": "Waiting for the far end",
  "语音通话": "Voice call",
  "拨号中": "Dialing",
  "振铃中": "Ringing",
  "通话中": "In call",
  ...
  "麦克风": "Microphone",
  "最近通话": "Recent calls",
  "还没有结束的通话": "No completed calls yet",
  "设备离线时无法发起通话": "The device is offline and cannot place a call",
  "USB SIM 读卡器只能在 VoWiFi IMS 就绪后通话": "USB SIM readers can only call after VoWiFi IMS is ready",
  "通话操作失败": "Call action failed",
  "键盘": "Keypad",
  "隐藏键盘": "Hide keypad",
  "录音": "Record",
  "停止录音": "Stop recording",
  "DTMF": "DTMF",
  "SIP 分机": "SIP extension",
  "浏览器 WebRTC 分机和外部 SIP 客户端可注册到这条线路": "The browser WebRTC extension and external SIP clients can register on this line",
  "WSS 地址": "WSS URL",
  "SIP UDP": "SIP UDP",
  复制: "Copy",
  "已复制 SIP 密码": "SIP password copied",
};
